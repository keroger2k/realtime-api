  ...
  return {
    ...
    parameters: {
      ...
      properties: {
        ...
        preferredTime: {
          type: "string",
          description: "Caller's preferred date and time in natural language (e.g., 'tomorrow at 2pm', 'next Monday morning')"
        },
        notes: {
          type: "string",
...
export async function handleCalendlyScheduling(args) {
  const { name, email, meetingType = 'consultation', preferredTime, notes = '' } = args;
