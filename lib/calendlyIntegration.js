...
export async function handleCalendlyScheduling(args) {
  // Support both 'preferredTime' and 'date' parameters for flexibility
  const preferredTime = args.preferredTime || args.date;
  const { name, email, meetingType = 'consultation', notes = '' } = args;
